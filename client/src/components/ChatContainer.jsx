  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
        ...
        <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
            ...
            <img onClick={handleSendMessage} src={assets.send_button} alt="" className='w-7 cursor-pointer hover:brightness-110 hover:scale-110 transition-all duration-300'/>
        </div>
    </div>
  ) : (

...
const Sidebar = () => {
  ...
  return (
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white shadow-[inset_-4px_0_6px_-2px_rgba(255,255,255,0.05)] ${selectedUser ? "max-hd:hidden" : ""} `}>
        ...
        <div className="pb-5">
          ...
          <div className="flex justify-between items-center">
              ...
              <div className='relative py-2 group'>
                  ...
                  <div className="absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#2821142] border border-gray-600 text-gray-100 hidden group-hover:block">
